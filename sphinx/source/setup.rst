...
.. hint:: 
   ...
   If any issues arise while setting up gräf, feel free to open an issue |issues_page|.
   
.. |issues_page| raw:: html

    <a href="https://github.com/heyuncle/graf/issues" target="_blank">here</a>
